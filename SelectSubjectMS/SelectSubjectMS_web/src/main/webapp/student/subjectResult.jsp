...
<body>
		<table class="easyui-datagrid" title="选题结果" id="dg" data-options="pagination:true" fit="true" url="${pageContext.request.contextPath}/student_subjectResult.action" rownumbers="true"
		                    toolbar="#tb">
		           <thead>
		               <tr>
