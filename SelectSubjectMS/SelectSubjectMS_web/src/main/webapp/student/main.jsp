...
<html>
	<head>
		...
		window.setTimeout(function(){
			$.messager.show({
				title:"消息提示",
				msg:"欢迎登录，${currentUser.schoolClass.major.yard.yardName}学生  ${currentUser.realName}！ <a href='javascript:void' onclick='top.showAbout();'>联系管理员</a>",
				timeout:5000
			});
		},3000);
		/*************/
			...
			var treeData2=[			               
			   {
				text:"查看个人信息",
				attributes:{
 					url:"${pageContext.request.contextPath}/student/studentInfo.jsp"
 				}	
			   },
			   {
					text:"修改个人信息 ",
					attributes:{
	 					url:"${pageContext.request.contextPath}/student/studentUpdate.jsp"
	 				}	
				   },
				   {
						text:"修改密码",
						attributes:{
		 					url:"${pageContext.request.contextPath}/student/modifyPwd.jsp"
		 				}	
					   }
			            ];
			 ...
			 var treeData3=[
			         {
			        	text:"选择题目志愿",
			        	attributes:{
			        		url:"${pageContext.request.contextPath}/student/selectSubject.jsp"
			        	}
			         },
			         {
			        	text:"已选题目",
			        	attributes:{
			        		url:"${pageContext.request.contextPath}/student/subject_choosed.jsp"
			        	}
			         },
			         {
				        	text:"选题结果",
				        	attributes:{
				        		url:"${pageContext.request.contextPath}/student/subjectResult.jsp"
				        	}
				         }
			                ];
	...
	<body class="easyui-layout">
		...
		<div style="position: absolute;right: 5px;top:35px;">
			当前院系：[<strong>${currentUser.schoolClass.major.yard.yardName}</strong>]
		</div>
		...
		<div region="west" style="width: 150px;" title="导航菜单"  split="false">
			...
			<div title="毕设选题" data-options="iconCls:'icon-mini-add'" style="overflow:auto" >
