...
<body>
        ...
        <div class="form row"  >
            <form action="${pageContext.request.contextPath}/user_login.action" method="post" id="form1">
            <div class="form-horizontal col-md-offset-3" id="login_form">
                <h3 class="form-title">Enter your information</h3>
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                            ...
                            <input class="form-control " type="password" placeholder="请输入密码" id="password" name="user.password" maxlength="8" value="${user.password}"/>
                    </div>
                     <div class="form-group" >
                    ...
                    <div class="form-group col-md-offset-6" >
                    	 <span id="span5">温馨提示：本科生登陆账号为学号，密码为学号后6位</span>
                    </div>
                    <div class="form-group col-md-offset-7" >
                    	 <a style="color:orange;font-size: 18px;text-align: center;" href="${pageContext.request.contextPath}/findPassword.jsp">忘记密码?</a>
                    </div>
                </div>
            </div> 
            </form>
