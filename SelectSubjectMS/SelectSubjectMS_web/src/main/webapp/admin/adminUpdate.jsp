...
<script type="text/javascript">
				...
				function updateAdmin(){
					$("#ff").form("submit",{
			    		 url:"${pageContext.request.contextPath}/admin_updatePersonalInfo.action", 
			    		onSubmit:function(){
...
<body>
	...
	<div style="width: 400px; padding: 30px 60px; margin-left: 300px">
		<form id="ff" data-options="novalidate:true" method="post">
			...
			<div style="margin-bottom: 20px">
				<div>姓名:</div>
				<input class="easyui-validatebox" name="admin.realName"
					style="width: 100%; height: 32px" value="${currentUser.realName}"
					required="true">
			</div>
			<div style="margin-bottom: 20px">
				<div>电话号码:</div>
				<input class="easyui-validatebox" name="admin.phone" id="phone"
					value="${currentUser.phone}" style="width: 100%; height: 32px"
					required="true" >
			</div>
			<div style="margin-bottom: 20px">
				<div>邮箱:</div>
				<input class="easyui-validatebox" name="admin.email" id="email"
			...
			<div>
				<a href="javascript:void(0)" class="easyui-linkbutton"
					iconCls="icon-ok" onclick="updateAdmin()">保存</a>
			</div>
		</form>
	</div>
</body>
