...
<html>
	<head>
		...
		window.setTimeout(function(){
			$.messager.show({
				title:"消息提示",
				msg:"欢迎登录，${currentUser.yard.yardName}老师  ${currentUser.realName}！ <a href='javascript:void' onclick='top.showAbout();'>联系管理员</a>",
				timeout:5000
			});
		},3000);
		/*************/
			...
			var treeData2=[			               
			   {
				text:"查看个人信息",
				attributes:{
 					url:"${pageContext.request.contextPath}/teacher/teacherInfo.jsp"
 				}	
			   },
			   {
					text:"修改个人信息 ",
					attributes:{
	 					url:"${pageContext.request.contextPath}/teacher/teacherUpdate.jsp"
	 				}	
				   },
				   {
						text:"修改密码",
						attributes:{
		 					url:"${pageContext.request.contextPath}/teacher/modifyPwd.jsp"
		 				}	
					   }
			            ];
			 ...
			 var treeData3=[
			                  {
			                	text:"查看学院所有选题",
			                	attributes:{
			                		url:"${pageContext.request.contextPath}/teacher/subjectListOfYard.jsp"
			                	}
			                  },
			                  {
				                	text:"查看个人出题",
				                	attributes:{
				                		url:"${pageContext.request.contextPath}/teacher/personalSubjectList.jsp"
				                	}
				                  },
			                  {
			                	text:"个人出题指派",
			                	attributes:{
			                		url:"${pageContext.request.contextPath}/teacher/subjectAssign.jsp"
			                	}
			                  },
			                  {
				                	text:"查看结果",
				                	attributes:{
				                		url:"${pageContext.request.contextPath}/teacher/assignResult.jsp"
				                	}
				                  }
			                ];
