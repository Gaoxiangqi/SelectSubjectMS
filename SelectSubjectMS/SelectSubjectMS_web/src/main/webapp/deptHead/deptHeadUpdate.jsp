...
<script type="text/javascript">
				...
				function updatePersonalInfo(){
					$("#ff").form("submit",{
			    		 url:"${pageContext.request.contextPath}/deptHead_updatePersonalInfo.action", 
			    		onSubmit:function(){
	    		...
	    		$(function(){
	    			$("input[name='deptHead.sex'][value='${currentUser.sex}']").attr("checked",true);
	    		});
		</script>
</head>
<body>
	...
	<div style="width: 400px; padding: 30px 60px; margin-left: 300px">
		<form id="ff" data-options="novalidate:true" method="post">
			...
			<div style="margin-bottom: 20px">
				<div>姓名:</div>
				<input class="easyui-validatebox" name="deptHead.realName"
					style="width: 100%; height: 32px" value="${currentUser.realName}"
					required="true">
			</div>
			<div style="margin-bottom: 20px">
				<div>性别:</div>
				   <input type="radio" name="deptHead.sex"  class="easyui-validatebox" required="true" value="男" >男
                   <input type="radio" name="deptHead.sex"  class="easyui-validatebox" required="true" value="女" >女                         
			</div>
			<div style="margin-bottom: 20px">
				<div>所属院系:</div>
				<input class="easyui-textbox" style="width: 100%; height: 32px"
					value="${currentUser.yard.yardName}" disabled="disabled">
			</div>
			<div style="margin-bottom: 20px">
				<div>电话号码:</div>
				<input class="easyui-validatebox" name="deptHead.phone" id="phone"
					value="${currentUser.phone}" style="width: 100%; height: 32px"
					required="true" >
			</div>
			<div style="margin-bottom: 20px">
				<div>邮箱:</div>
				<input class="easyui-validatebox" name="deptHead.email" id="email"
